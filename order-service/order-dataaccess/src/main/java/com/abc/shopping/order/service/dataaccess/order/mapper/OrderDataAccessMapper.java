package com.abc.shopping.order.service.dataaccess.order.mapper;

import com.abc.shopping.domain.valueobject.*;
...
import static com.abc.shopping.order.service.domain.entity.Order.FAILURE_MESSAGE_DELIMITER;
...
public class OrderDataAccessMapper {
    ...
    public OrderEntity orderToOrderEntity(Order order) {
        OrderEntity orderEntity = OrderEntity.builder()
                ...
                .deliveryId(order.getDeliveryId().getValue())
    ...
    private List<OrderItemDomain> orderItemEntitiesToOrderItems(List<OrderItemEntity> items) {
        return items.stream()
                .map(orderItemEntity -> OrderItemDomain.builder()
    ...
    private List<OrderItemEntity> orderItemsToOrderItemEntities(List<OrderItemDomain> items) {
        return items.stream()
